...
public class RacketDetailsViewModel implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(String.format("Category: %s", this.categoryName)).append(System.lineSeparator());
